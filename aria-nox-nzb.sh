...
aria2c --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=false --bt-detach-seed-only=true \
       ...
       --min-split-size=10M --follow-torrent=false --follow-metalink=false --check-certificate=false --optimize-concurrent-downloads=false \
